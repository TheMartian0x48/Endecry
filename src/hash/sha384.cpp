...
std::vector<uint8_t> SHA384::GenerateHash(std::istream& in) {
  uint64_t H0 = 0Xcbbb9d5dc1059ed8, H1 = 0X629a292a367cd507, H2 = 0X9159015a3070dd17, H3 = 0X152fecd8f70e5939;
  uint64_t H4 = 0X67332667ffc00b31, H5 = 0X8eb44a8768581511, H6 = 0Xdb0c2e0d64f98fa7, H7 = 0X47b5481dbefa4fa4;
...
void SHA384::ComputeHash(unsigned char *M,
